...
public class XacNhanHoanTatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_xac_nhan_hoan_tat, container, false);
        anhXa();
    ...
    private void setRvTatCaDonHang() {
        //
        apiService.getOrderByStore(sharedPrefManager.getStoreId(),3).enqueue(new Callback<OrderResponse>() {
            @Override
